    ...
    >
      ...
      <div className="w-full max-w-sm mx-auto px-4 py-4 overflow-hidden md:max-w-xl md:px-6 md:py-6 lg:max-w-2xl xl:max-w-3xl">
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === "version")?.content ||
              "Version 2.1.0"}
          </div>
        </motion.div>
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === "features-title")
              ?.title || "Features"}
          </h3>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find((s) => s.id === "ai-assistance")
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find(
                    (s) => s.id === "personalized-recommendations",
                ...
                >
                  {pageContent?.sections.find(
                    ...
                    "Get program recommendations based on your interests"}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === "mission-title")
              ?.title || "Our Mission"}
          </h3>
          <p
