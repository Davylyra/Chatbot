    ...
    >
      ...
      <div className="w-full max-w-sm mx-auto px-4 py-4 overflow-hidden md:max-w-xl md:px-6 md:py-6 lg:max-w-2xl xl:max-w-3xl">
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === 'app-title')?.content ||
              'Your AI Assistant for Ghana University Admissions'}
          </p>
          <div
            className={`px-3 py-1 rounded-full text-sm font-medium inline-block transition-colors duration-200 ${
              theme === 'dark'
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'ai-assistance')?.title ||
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'ai-assistance')?.content ||
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'university-network')?.title ||
                    'University Network'}
                </h4>
                <p
                  className={`text-sm transition-colors duration-200 ${
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'university-network')?.content ||
                    'Access information from all major Ghanaian universities'}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'personalized-recommendations')
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === 'mission-title')?.content ||
