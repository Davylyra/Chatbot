    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="w-full max-w-sm mx-auto px-4 py-4 overflow-hidden md:max-w-xl md:px-6 md:py-6 lg:max-w-2xl xl:max-w-3xl">
                      ...
                      >
                        ...
                        <AnimatePresence>
                          {isExpanded && (
                            ...
                            >
                              <div
                                className={`px-4 pb-4 border-t transition-colors duration-200 ${
                                  theme === 'dark'
        ...
        >
          ...
          >
            {pageContent?.sections.find((s) => s.id === 'get-in-touch-title')?.title ||
              'Get in Touch'}
          </h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {pageContent?.sections.find((s) => s.id === 'live-chat')?.content ||
                    'Available 24/7'}
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                >
                  {import.meta.env.VITE_CONTACT_PHONE ||
                    pageContent?.sections.find((s) => s.id === 'phone-support')?.content ||
                    ''}
                </p>
              </div>
            </div>
