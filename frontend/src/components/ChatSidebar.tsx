...
const ChatSidebar: React.FC<ChatSidebarProps> = memo(
  ({ isOpen, onClose, isDesktop = false }) => {
      ...
      },
      {
        ...
        action: () =>
          navigate("/chat", {
            state: {
              forceNewConversation: true,
              initialMessage: "Compare KNUST and UG",
            },
          }),
      },
      {
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide flex flex-col">
            ...
            <div className={`${isOpen ? "px-5 py-4" : "px-2 py-4"} shrink-0`}>
              ...
              <div
                className={`space-y-2 ${!isOpen && "flex flex-col items-center"}`}
              >
            ...
            <div className={`${isOpen ? "px-5 py-2" : "px-2 py-2"} flex-1`}>
              ...
              <div
                className={`space-y-1 pb-4 ${!isOpen && "flex flex-col items-center"}`}
              >
                {loading
                  ? isOpen && (
                      <div
