...
export function generateMockRecommendations(
  ...
  if (
    ...
    recommendations.push({
      ...
      requirements: ["Mathematics", "English", "Science"],
      description:
        "Specialized program that aligns with your career aspirations in technology.",
  ...
  if (
    ...
    recommendations.push({
      ...
      description:
        "Excellent choice based on your business interests and career goals.",
    ...
    recommendations.push({
      ...
      description:
        "Leading professional studies program for accounting and finance careers.",
  ...
  if (
    ...
    recommendations.push({
      ...
      requirements: ["Mathematics", "Physics", "Chemistry"],
      description:
        "Specialized mining engineering program with excellent industry connections.",
  ...
  if (
    interestKeywords.includes("medicine") ||
    interestKeywords.includes("health")
  ) {
    recommendations.push({
      id: "7",
      university: "UHAS",
      ...
      description:
        "Leading health sciences university with comprehensive medical program.",
  ...
  if (
    interestKeywords.includes("education") ||
    interestKeywords.includes("teaching")
  ) {
    recommendations.push({
      id: "8",
      university: "UEW",
      ...
      requirements: ["Mathematics", "English", "Science"],
      description:
        "Premier teacher education institution with strong mathematics program.",
    ...
    recommendations.push(
      {
        ...
        description:
          "Flexible arts program that allows you to explore various fields.",
      ...
      },
      {
        ...
        requirements: ["English", "Social Studies"],
        description:
          "Focus on development and community engagement with affordable fees.",
