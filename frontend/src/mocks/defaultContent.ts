    ...
    about: {
      ...
      sections: [
        ...
        },
        {
          id: "version",
          title: "Version",
          content: import.meta.env.VITE_APP_VERSION as string,
          type: "text",
        },
        {
          id: "features-title",
    ...
    "help-support": {
      ...
      sections: [
        ...
        },
        {
          id: "email-support",
          title: "Email",
          content: import.meta.env.VITE_CONTACT_EMAIL as string,
          type: "text",
        },
        {
          id: "phone-support",
          title: "Phone",
          content: import.meta.env.VITE_CONTACT_PHONE as string,
          type: "text",
        },
      ],
      lastUpdated: new Date().toISOString(),
