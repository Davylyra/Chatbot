...
export const parseWassceResult = async (
  ...
  try {
    ...
    const parseLineForSubject = (line: string): string | null => {
      if (line.includes("elective") || line.includes("further"))
        return "Elective Mathematics";
      if (line.includes("math")) return "Core Mathematics";
      if (line.includes("english") || line.includes("lang"))
      ...
      if (line.includes("social") || line.includes("soc"))
      ...
      if (line.includes("physical") || line.includes("p.e"))
      ...
      if (line.includes("account") || line.includes("financ"))
        return "Financial Accounting";
      if (line.includes("cost")) return "Cost Accounting";
      if (
        line.includes("typewrit") ||
        line.includes("clerical") ||
